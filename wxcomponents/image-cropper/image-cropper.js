Component({
    ...
    data: {
        ...
        _canvas_overflow: false, //canvas缩略图是否在屏幕外面
        _canvas_width: 200,
        _canvas_height: 200,
        origin_x: 0.5, //图片旋转中心
        origin_y: 0.5, //图片旋转中心
    ...
    methods: {
        ...
        _draw(callback) {
            ...
            let draw = () => {
                ...
                // this.data.ctx.drawImage(this.data.imgSrc, 0, 0 , img_width, img_height);
                this.data.ctx.draw(false, () => {
                    callback && callback();
                    this.triggerEvent('canvasDraw', {
                        img: this.data.imgSrc,
                        xpos: xpos,
                        ypos: ypos,
                        img_width: img_width,
                        img_height: img_height,
                        export_scale: this.data.export_scale
                    })
                });
            }
